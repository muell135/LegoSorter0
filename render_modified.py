...
class BrickRenderer:
    ...
    def set_physics(self):
        ...
        #ensure brick doesn't land above or below plane
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scene", help="a path to the pattern scene", default=LEGO_HOME+'/dataset/scenes/simple.blend', required=False)
